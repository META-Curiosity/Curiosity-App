...
class UserDbService {
  ...
  Future<Map<String, dynamic>> updateMindfulReminders(
    ...
    try {
      ...
      await usersCollection
          .doc(uid)
          .update({'mindfulReminders': data['reminders']});
      log.successObj(
          {'method': 'updateMindfulReminders - success', 'data': data});
      return {'msg': 'Update mindful reminders successful'};
    } catch (error) {
      log.errorObj({
  ...
  Future<Map<String, dynamic>> updateCompleteActivityReminders(
    ...
    try {
      ...
      await usersCollection
          .doc(uid)
          .update({'completeActivityReminders': data['reminders']});
      log.successObj(
          {'method': 'updateCompleteActivityReminder - success', 'data': data});
      return {'msg': 'Update activity completion reminder successful'};
    } catch (error) {
      log.errorObj({
